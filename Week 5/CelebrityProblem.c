...
Given a matrix C where:
C[i][j] = 1 means person i knows person j.
C[i][j] = 0 means person i does not know person j.

Find the celebrity if one exists. If no celebrity exists, return -1.
*/
